...
--
-- Struttura della tabella `psg_invoices_purchases`
--

CREATE TABLE `psg_invoices_purchases` (
  `id` int(8) NOT NULL,
...
--
-- Indici per le tabelle `psg_invoices_purchases`
--
ALTER TABLE `psg_invoices_purchases`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT per la tabella `psg_invoices_purchases`
--
ALTER TABLE `psg_invoices_purchases`
