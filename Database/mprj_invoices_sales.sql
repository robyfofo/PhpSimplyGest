...
--
-- Host: localhost:3306
-- Creato il: Mar 16, 2019 alle 11:22
...
--
-- Struttura della tabella `mprj_invoices_sales`
--

CREATE TABLE `mprj_invoices_sales` (
  `id` int(8) NOT NULL,
...
--
-- Indici per le tabelle `mprj_invoices_sales`
--
ALTER TABLE `mprj_invoices_sales`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_customer` (`id_customer`),
  ADD KEY `id_user` (`id_user`),
  ADD KEY `active` (`active`),
  ADD KEY `pagata` (`pagata`);
...
--
-- AUTO_INCREMENT per la tabella `mprj_invoices_sales`
--
ALTER TABLE `mprj_invoices_sales`
