...
--
-- Host: localhost:3306
-- Creato il: Set 21, 2020 alle 17:12
...
--
-- Struttura della tabella `psg130_location_province`
--

CREATE TABLE `psg130_location_province` (
...
--
-- Dump dei dati per la tabella `psg130_location_province`
--

INSERT INTO `psg130_location_province` (`id`, `nome`, `targa`, `active`) VALUES
(1, 'Torino', 'TO', NULL),
(2, 'Vercelli', 'VC', NULL),
(3, 'Novara', 'NO', NULL),
(4, 'Cuneo', 'CN', NULL),
...
--
-- Indici per le tabelle `psg130_location_province`
--
ALTER TABLE `psg130_location_province`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT per la tabella `psg130_location_province`
--
ALTER TABLE `psg130_location_province`
