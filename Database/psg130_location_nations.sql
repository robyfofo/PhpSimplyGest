...
--
-- Struttura della tabella `psg130_location_nations`
--

CREATE TABLE `psg130_location_nations` (
  `id` int(11) NOT NULL,
...
--
-- Dump dei dati per la tabella `psg130_location_nations`
--

INSERT INTO `psg130_location_nations` (`id`, `title_it`, `title_en`, `title_de`, `title_es`, `title_fr`, `title_pt`, `title_ru`, `title_jp`, `targa`, `active`) VALUES
...
--
-- Indici per le tabelle `psg130_location_nations`
--
ALTER TABLE `psg130_location_nations`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT per la tabella `psg130_location_nations`
--
ALTER TABLE `psg130_location_nations`
