...
--
-- Struttura della tabella `psg_invoices_sales_articles`
--

CREATE TABLE `psg_invoices_sales_articles` (
  `id` int(8) NOT NULL,
...
--
-- Indici per le tabelle `psg_invoices_sales_articles`
--
ALTER TABLE `psg_invoices_sales_articles`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT per la tabella `psg_invoices_sales_articles`
--
ALTER TABLE `psg_invoices_sales_articles`
