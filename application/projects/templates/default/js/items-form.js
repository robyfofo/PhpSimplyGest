/* admin/projects/items-form.js v.1.0.0. 16/02/2017 */
...
tinymce.init({
	...
	external_filemanager_path: siteUrl+"/application/filemanager/",
	external_plugins: { "filemanager" : siteUrl+"/application/filemanager/plugin.min.js"},
