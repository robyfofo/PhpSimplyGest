				...
				<div class="tab-pane active" id="datibase-tab">	
					<fieldset class="form-group">
						<div class="form-group">
							...
							<div class="col-md-7">
								<input required type="text" name="name" class="form-control" id="nameID" placeholder="{{ Lang['inserisci un nome'] }}" value="{{ App.item.name }}">
					    	</div>
						</div>
						<div class="form-group">
							<label for="surnameID" class="col-md-3 control-label">{{ Lang['cognome']|capitalize }}</label>
							<div class="col-md-7">
								<input type="text" name="surname" class="form-control" id="surnameID" placeholder="{{ Lang['inserisci un cognome'] }}" value="{{ App.item.surname }}">
					    	</div>
						</div>
						<hr>
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" name="street" class="form-control" id="streetID" placeholder="{{ Lang['inserisci un indirizzo'] }}" value="{{ App.item.street }}">
					    	</div>
						</div>		
						<div class="form-group">
							<label for="cityID" class="col-md-3 control-label">{{ Lang['città']|capitalize }}</label>
							<div class="col-md-7">
								<input type="text" name="city" class="form-control" id="cityID" placeholder="{{ Lang['inserisci una città'] }}" value="{{ App.item.city }}">
					    	</div>
						</div>	
						<div class="form-group">
							<label for="zip_codeID" class="col-md-3 control-label">{{ Lang['cap']|capitalize }}</label>
							<div class="col-md-7">
								<input type="text" name="zip_code" class="form-control" id="zip_codeID" placeholder="{{ Lang['inserisci un cap'] }}" value="{{ App.item.zip_code }}">
					    	</div>
						</div>
						<div class="form-group">
							<label for="provinceID" class="col-md-3 control-label">{{ Lang['provincia']|capitalize }}</label>
							<div class="col-md-7">
								<input type="text" name="province" class="form-control" id="provinceID" placeholder="{{ Lang['inserisci una provincia'] }}" value="{{ App.item.province }}">
					    	</div>
						</div>
						<div class="form-group">
							<label for="provinceID" class="col-md-3 control-label">{{ Lang['stato']|capitalize }}</label>
							<div class="col-md-7">
								<input type="text" name="state" class="form-control" id="stateID" placeholder="{{ Lang['inserisci uno stato'] }}" value="{{ App.item.state }}">
					    	</div>
						</div>
						<hr>
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="email" name="email" class="form-control" id="emailID" placeholder="{{ Lang['inserisci un indirizzo email'] }}"  value="{{ App.item.email }}">
					    	</div>
						</div>
							<div class="form-group">
							<label for="telephoneID" class="col-md-3 control-label">{{ Lang['telefono']|capitalize }}</label>
							<div class="col-md-7">
								<input type="text" name="telephone" class="form-control" id="telephoneID" placeholder="{{ Lang['inserisci un numero di telefono'] }}"  value="{{ App.item.telephone }}">
					    	</div>
						</div>
						<div class="form-group">
							<label for="mobileID" class="col-md-3 control-label">{{ Lang['cellulare']|capitalize }}</label>
							<div class="col-md-7">
								<input type="text" name="mobile" class="form-control" id="mobileID" placeholder="{{ Lang['inserisci un numero di cellulare'] }}"  value="{{ App.item.mobile }}">
					    	</div>
						</div>
						<div class="form-group">
							<label for="emailID" class="col-md-3 control-label">{{ Lang['fax']|capitalize }}</label>
							<div class="col-md-7">
								<input type="text" name="fax" class="form-control" id="faxID" placeholder="{{ Lang['inserisci un numero di fax'] }}"  value="{{ App.item.fax }}">
					    	</div>
						</div>
						<div class="form-group">
							<label for="skypeID" class="col-md-3 control-label">{{ Lang['skype']|capitalize }}</label>
							<div class="col-md-7">
								<input type="text" name="skype" class="form-control" id="skypeID" placeholder="{{ Lang['inserisci un username skype'] }}"  value="{{ App.item.skype }}">
					    	</div>
						</div>
						<hr>
						<div class="form-group">
