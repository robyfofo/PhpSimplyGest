<!-- invoices/listItas.tpl.php v.1.0.0. 09/02/2018 -->	
<?php if (is_array($App->items) && count($App->items) > 0): ?>
	<?php foreach ($App->items AS $key=>$value): ?>	
		<tr>
			...
			<td class="actions">
				<button type="button" class="btn btn-default btn-circle" data-toggle="modal" data-target="#myModal"  data-whatever="@mdo" data-art="<?php echo $value->id; ?>" title="<?php echo $_lang['modifica'] .' '.$_lang['la voce-p']; ?>"><i class="fa fa-edit"> </i></button>			
