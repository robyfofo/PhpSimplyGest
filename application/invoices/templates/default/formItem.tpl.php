...
<div class="row">
	<div class="col-lg-12"> 
      	<form id="movimentoFormID" data-async class="form-horizontal" role="form" action="#"  enctype="multipart/form-data" method="post">
				<div class="row">
					<fieldset class="form-group">
						<div class="form-group">
							<label for="content_movID" class="col-md-2 control-label"><?php echo ucfirst($_lang['contenuto']); ?> AJAX</label>
							<div class="col-md-8">
					...
					<div class="form-group">
						...
						<div class="col-md-2">
							...
							<button onclick="deleteMov(<?php echo $App->item->id; ?>)" type="button" id="deleteMovID" href="#" title="<?php echo ucfirst($_lang['cancella']); ?>" class="btn btn-danger"><?php echo ucfirst($_lang['cancella']); ?></button>
							<?php endif; ?>
						</div>
					</div>
				</div>	
...
<button id="ddeleteMovID" type="button" name="ddeleteMov" class="btn btn-primary" title="<?php echo ucfirst($_lang['cancella']); ?>"><?php echo ucfirst($_lang['cancella']); ?></button>	
