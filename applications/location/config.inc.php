...
$App->params->fields['comuni'] = array(
	...
	'provincia'				=> array('label'=>$_lang['provincia'],'searchTable'=>true,'required'=>false,'type'=>'varchar|255','defValue'=>''),
	'location_province_id'	=> array('label'=>$_lang['provincia'],'searchTable'=>false,'required'=>false,'type'=>'int|10','defValue'=>0),

	'nation'				=> array('label'=>$_lang['nazione'],'searchTable'=>true,'required'=>false,'type'=>'varchar|255','defValue'=>''),
