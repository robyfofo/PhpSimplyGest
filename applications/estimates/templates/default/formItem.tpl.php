<!-- estimates/formItem.tpl.php 04/06/2018 -->
<div class="row">
...
<div class="row">
	<div class="col-lg-12">		
		...
		<ul class="nav nav-tabs">
			...
			{% if App.id > 0 %}<li class="{% if App.tabActive == 2 %}active{% endif %}"><a href="#articles-tab" data-toggle="tab">{{ Lang['articoli associati']|capitalize }} <i class="fa"></i></a></li>{% endif %}
