 ...
 * invoices/config.inc.php v.1.0.0. 24/07/2018
*/
...
$App->params->fields['InvSal']  = array(
	...
	'customer_email'=>array('label'=>$_lang['email'],'searchTable'=>true,'required'=>false,'type'=>'varchar|255'),
	'customer_fax'=>array('label'=>$_lang['fax'],'searchTable'=>true,'required'=>false,'type'=>'varchar|20'),
	'customer_partita_iva'=>array('label'=>$_lang['partita IVA'],'searchTable'=>false,'required'=>false,'type'=>'varchar|50'),
