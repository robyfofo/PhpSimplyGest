...
--
-- Host: localhost:3306
-- Creato il: Mar 12, 2019 alle 09:16
...
--
-- Struttura della tabella `app_thirdparty`
--

CREATE TABLE `app_thirdparty` (
  `id` int(8) NOT NULL,
...
--
-- Indici per le tabelle `app_thirdparty`
--
ALTER TABLE `app_thirdparty`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT per la tabella `app_thirdparty`
--
ALTER TABLE `app_thirdparty`
