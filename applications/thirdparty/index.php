 ...
 * third-party/index.php v.1.2.0. 12/08/2020
*/
...
switch(substr(Core::$request->method,-4,4)) {
	...
	break;		
	default:
		if (Sql::countRecordQry($App->params->tables['cate'],'id','active = ?',array(1)) == 0) ToolsStrings::redirect(URL_SITE.'error/module/'.urlencode($App->params->label).'/'.urlencode(preg_replace('/%ITEM%/',$_lang['categoria'],$_lang['Devi creare o attivare almeno una %ITEM%'])));
