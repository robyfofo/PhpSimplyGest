 ...
 * core/nousername.php v.1.0.0. 29/01/2018
*/
...
//$App->jscript[] = '<script src="'.URL_SITE.$App->pathApplicationsCore.'/templates/'.$App->templateUser.'/js/nousername.js" type="text/javascript"></script>';
?>