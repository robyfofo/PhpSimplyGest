...
--
-- Host: localhost:3306
-- Creato il: Set 17, 2020 alle 17:05
...
INSERT INTO `app130_company` (`id`, `ragione_sociale`, `name`, `surname`, `street`, `city`, `zip_code`, `province`, `state`, `email`, `telephone`, `mobile`, `fax`, `partita_iva`, `codice_fiscale`, `gestione_iva`, `iva`, `text_noiva`, `gestione_rivalsa`, `rivalsa`, `text_rivalsa`, `banca`, `intestatario`, `iban`, `bic_swift`) VALUES
(1, 'Roberto Mantovani aa', 'Roberto bb', 'Mantovani cc', 'Via Garofoli, 302 cc ', 'San Giovanni Lupatoto', '37057', 'Verona', 'Italia', 'me@robertomantovani.vr.it', '045548841xxxx', '32915xxxxx', '0452xxxxx', 'IT03781xxxxxxxx', 'MNTRxxxxxxxx', 0, 22, 'Operazione effettuata ai sensi dell’art. 1, commi da 54 a 89 della Legge n. 190/2014 – Regime forfettario', 1, 4, 'RIVALSA INPS 4%', 'Banco Posta', 'Roberto Mantovani', 'ITxxxxxxxxxxxxxxxxx22787', 'BPXXXXXXXX');
